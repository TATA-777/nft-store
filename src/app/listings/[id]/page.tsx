          ...
          {!item.sold && !isOwner && (
            <div className="flex gap-4 mt-4">
              ...
              <button
                ...
                className="bg-black-700 text-white px-5 py-2 rounded-lg font-semibold hover:bg-black-800 cursor-pointer transition"
              >
                장바구니 담기
              </button>
            </div>
              ...
              {!isEditing ? (
                <div className="flex gap-3">
                  <button
                    ...
                    className="px-4 py-2 rounded-lg border border-black-600 text-black-700 font-medium
             hover:bg-black-600 hover:text-white cursor-pointer transition"
                  >
                    수정하기
                  </button>

    ...
    <main className="max-w-[1100px] mx-auto px-4 py-10 space-y-8">
      ...
      <section className="border rounded-2xl px-6 py-5 space-y-4 bg-white/70">
        ...
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 rounded-full bg-black-200 flex items-center justify-center text-lg font-bold text-black-700">
            {displayNickname[0] ?? 'U'}
          </div>
        ...
        <div className="mt-4 space-y-2 text-sm">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2 rounded-md bg-black-600 text-white text-sm disabled:opacity-60"
            >
        ...
        <div className="flex items-center justify-between">
          ...
          {ownedNFTs.length > MAX_PREVIEW && (
            <button
              ...
              className="text-xs text-black-700 underline"
            >
              {showAllOwned ? '접기' : '더보기'}
            </button>
          )}
